      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-20 animate-in fade-in slide-in-from-top-4 duration-700">
          <h1 className="text-4xl sm:text-6xl font-black mb-6 tracking-tight">
            Built with <br />
            <span className="text-black">Hackathon Copilot.</span>
          </h1>
          <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed font-medium">
            Join the students and developers who use our tool to build winning projects in record
            time.
          </p>
        </div>
              ...
              <div className="px-4">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {c.tools.split(', ').map((tool) => (
                    <span
                      key={tool}
                      className="text-[10px] font-black text-gray-400 bg-gray-100 px-2 py-1 rounded-lg italic"
                    >
                      #{tool.replace(' ', '')}
                    </span>
                  ))}
