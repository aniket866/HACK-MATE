...
export function ProjectSetup({ initialProblem, onComplete, onBack }: ProjectSetupProps) {
  ...
  const [judgingFocus, setJudgingFocus] = React.useState<string[]>([
    'Innovation',
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-bold transition-all border ${
                    judgingFocus.includes(focus)
