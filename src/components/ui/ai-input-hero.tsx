    ...
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-white text-gray-900 selection:bg-gray-900 selection:text-white font-sans">
      ...
      <nav className="w-full max-w-7xl mx-auto p-6 flex justify-between items-center z-50">
        ...
        <div className="hidden lg:flex items-center gap-6 text-sm font-medium text-gray-600">
          <button onClick={onOpenHowItWorks} className="hover:text-gray-900 transition-colors">
            How it Works
          </button>
          <button onClick={onOpenFeatures} className="hover:text-gray-900 transition-colors">
            Features
          </button>
          <button onClick={onOpenResources} className="hover:text-gray-900 transition-colors">
            Resources
          </button>
          <button onClick={onOpenCaseStudies} className="hover:text-gray-900 transition-colors">
            Success Stories
          </button>
          <button onClick={onOpenGuide} className="hover:text-gray-900 transition-colors">
            Guide
          </button>
          <button onClick={onOpenFAQ} className="hover:text-gray-900 transition-colors">
            FAQ
          </button>
          ...
          {user ? (
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={onLogout}
                className="px-4 py-2 rounded-full border border-gray-200 hover:bg-gray-50 transition-colors text-gray-600"
              >
                Sign Out
              </button>
            </div>
            ...
            <button
              onClick={onLogin}
              className="px-6 py-2 rounded-full bg-gray-900 hover:bg-black text-white font-bold transition-all transform hover:scale-105 active:scale-95 shadow-lg shadow-gray-900/20"
            >
              Sign In
            </button>
          )}
          <a
            href="https://github.com/anandmahadev/HACK-MATE"
            target="_blank"
            rel="noreferrer"
            title="View on GitHub"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors text-gray-900 group"
          >
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-6 flex flex-col items-center justify-center text-center z-10 pt-10 pb-20">
        ...
        <p className="text-lg sm:text-2xl text-gray-500 mb-12 max-w-2xl mx-auto leading-relaxed font-normal animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-100">
          Describe your problem statement. We'll generate the perfect workflow, tools, and prompts
          to build it in 48 hours.
        </p>
        ...
        <div className="w-full max-w-2xl mx-auto relative group animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200 z-20">
          ...
          <form
            ...
            className="relative flex flex-col sm:flex-row items-stretch sm:items-center bg-white rounded-2xl sm:rounded-3xl shadow-2xl shadow-gray-200/50 border border-gray-100 p-2 focus-within:ring-2 focus-within:ring-gray-900/5 transition-all"
          >
                ...
                <div className="group">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl border border-gray-700/50 group-hover:border-gray-600 transition-colors">
                    <code className="text-blue-400">
                      git clone https://github.com/antigravity/engine.git
                    </code>
        ...
        {recentProjects.length > 0 && (
          <div className="relative sm:absolute sm:top-24 sm:right-12 z-20 mt-8 sm:mt-0 animate-in fade-in slide-in-from-right-4 duration-700 delay-500">
            <div className="bg-white/80 backdrop-blur-sm border border-gray-100 shadow-xl rounded-2xl p-4 max-w-sm mx-auto sm:mx-0">
              <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 px-1">
                Resume Work
              </h3>
              <div className="space-y-2">
                {recentProjects.map((p) => (
                  ...
                  >
                    <span className="truncate max-w-[150px] font-bold text-gray-800">
                      {p.name || 'Untitled'}
                    </span>
