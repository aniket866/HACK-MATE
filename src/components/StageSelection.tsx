      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-gray-500 mt-2 font-medium">
              Click on a phase to start working on your roadmap.
            </p>
          </div>
        ...
        {showShare && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-md animate-in fade-in duration-300">
            <div
              className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg p-10 border border-gray-100 relative overflow-hidden"
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-500 font-medium">
                  Copy this link to share your project roadmap and collaborate in real-time.
                </p>
              </div>

              <div className="space-y-4">
                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-2xl border border-gray-200">
                  <div className="flex-1 truncate font-mono text-sm text-gray-500">{shareUrl}</div>
                  <button
                    onClick={handleCopy}
                ...
                <p className="text-center text-xs text-gray-400 font-medium italic">
                  NOTE: Link contains encoded project data. Large projects may have very long links.
                </p>
              </div>
            </div>
          </div>
        ...
        <PromptModal
          ...
          title={
            assigningStage && assignments[assigningStage]
              ? 'Edit assignment'
              : 'Assign to your mate'
          }
