        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="max-w-3xl mx-auto px-6 py-20">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-500 text-lg">Everything you need to know about the Hackathon Copilot.</p>
                </div>
                ...
                <div className="mt-20 p-8 bg-gray-50 rounded-3xl border border-gray-200 text-center">
                    ...
                    <p className="text-gray-500 mb-6 font-medium">We're here to help you win. Reach out to us on Discord or GitHub.</p>
                    <div className="flex flex-wrap justify-center gap-4">
                        <button className="bg-black text-white px-6 py-3 rounded-xl font-bold hover:bg-gray-900 transition-colors">Join Discord</button>
                        <button className="bg-white text-gray-900 px-6 py-3 rounded-xl font-bold border border-gray-200 hover:bg-gray-100 transition-colors">Email Support</button>
                    </div>
                </div>
            </main>
        </div>
