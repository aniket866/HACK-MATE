    ...
    <div className="min-h-screen bg-gray-50/30">
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-20 animate-in fade-in slide-in-from-top-4 duration-700">
          <h1 className="text-4xl sm:text-6xl font-extrabold mb-6 tracking-tight text-gray-900">
            Built for the <br />
          ...
          <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Everything you need to go from a blank screen to a world-class project. No fluff, just
            the essentials for winning.
          </p>
        </div>
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-500 text-lg mb-8">
                Watch how a solo developer built a fully functional ML project in just 30 minutes
                using Hackathon Copilot.
              </p>
