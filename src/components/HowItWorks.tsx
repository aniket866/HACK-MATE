      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        <div className="text-center mb-20">
          <h1 className="text-4xl sm:text-5xl font-bold mb-6 tracking-tight">
            The 7-Phase Hackathon Workflow
          </h1>
          <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
            We've mapped out the exact path to a winning project. Our tool guides you through each
            phase with specific tools and AI prompts.
          </p>
        </div>
        ...
        <div className="relative space-y-4">
          ...
          {phases.map((phase, i) => (
            <div
              key={i}
              className="relative flex flex-col sm:flex-row gap-6 p-6 rounded-2xl border border-gray-100 bg-white hover:border-gray-900/10 hover:shadow-lg hover:shadow-gray-900/5 transition-all group animate-in slide-in-from-bottom-4 fade-in duration-500"
            ...
            >
              ...
              <div className="flex-1 pt-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-bold text-gray-900 uppercase tracking-widest bg-gray-100 px-2 py-0.5 rounded">
                    Phase {i + 1}
                  </span>
        ...
        <div className="mt-24 p-12 bg-gray-900 rounded-[2.5rem] text-white text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-md mx-auto">
            Skip the setup and start building. Our tool handles the strategy while you focus on the
            code.
          </p>
          <button
            onClick={onBack}
